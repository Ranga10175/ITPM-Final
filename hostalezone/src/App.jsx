...
// Ranga
import R_AdminDashboard from "./components/RANGA/AdminDashboardR";
import R_AdminLeaveManagement from "./components/RANGA/AdminLeaveManagementR";
import StudentRegistration from "./components/Auth/StudentRegistration";
import SignIn from "./components/Auth/SignIn";
import StudentProfile from "./components/Auth/StudentDashboard";
import PaymentDetailsR from "./components/Auth/PaymentDetailsR";
// import LeaveRequest from "./components/RANGA/LeaveRequest"; // Missing file
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/student-payments" element={<PaymentDetailsR />} />
